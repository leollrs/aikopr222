  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 rounded-full border px-4 py-3 transition-all"
        style={{
      ...
      <ChatDrawer
        ...
        webhookUrl={N8N_WEBHOOK_URL}   {/* 👈 THIS IS THE KEY */}
      />
    </>
  );
}